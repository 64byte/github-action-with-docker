...
cat ./conf.d/nginx/http.template | tee ./conf.d/nginx/default.template
...
cat ./conf.d/nginx/http.template ./conf.d/nginx/https.template | tee ./conf.d/nginx/default.template
